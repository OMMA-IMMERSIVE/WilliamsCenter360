...
Dropdown_EXTERIOR_SOURCE="$ROOT_DIR/post-export/assets/wc360-dropdown-exterior-style.js"
Dropdown_EXTERIOR_TARGET="$CUSTOM_DIR/wc360-dropdown-exterior-style.js"
...
perl -0pi -e 's#\s*<!-- WC360_POST_EXPORT:dropdown-exterior:start -->.*?<!-- WC360_POST_EXPORT:dropdown-exterior:end -->##sg' "$INDEX_FILE"
...
cp "$Dropdown_EXTERIOR_SOURCE" "$Dropdown_EXTERIOR_TARGET"
...
perl -0pi -e 's#(\s*<!-- WC360_POST_EXPORT:mode:end -->)#$1\n    <!-- WC360_POST_EXPORT:menu-autocycle:start -->\n    <script src="custom/wc360-menu-autocycle.js?v=25"></script>\n    <!-- WC360_POST_EXPORT:menu-autocycle:end -->#s' "$INDEX_FILE"
perl -0pi -e 's#(\s*<!-- WC360_POST_EXPORT:menu-autocycle:end -->)#$1\n    <!-- WC360_POST_EXPORT:responsive-menu:start -->\n    <script src="custom/wc360-responsive-menu.js?v=12"></script>\n    <!-- WC360_POST_EXPORT:responsive-menu:end -->#s' "$INDEX_FILE"
perl -0pi -e 's#(\s*<!-- WC360_POST_EXPORT:responsive-menu:end -->)#$1\n    <!-- WC360_POST_EXPORT:dropdown-exterior:start -->\n    <script src="custom/wc360-dropdown-exterior-style.js?v=1"></script>\n    <!-- WC360_POST_EXPORT:dropdown-exterior:end -->#s' "$INDEX_FILE"
