...
VIDEO_COVER_SOURCE="$ROOT_DIR/post-export/assets/wc360-video-cover.js"
VIDEO_COVER_TARGET="$CUSTOM_DIR/wc360-video-cover.js"
...
perl -0pi -e 's#\s*<!-- WC360_POST_EXPORT:video-cover:start -->.*?<!-- WC360_POST_EXPORT:video-cover:end -->##sg' "$INDEX_FILE"
...
cp "$VIDEO_COVER_SOURCE" "$VIDEO_COVER_TARGET"
...
perl -0pi -e 's#(\s*<!-- WC360_POST_EXPORT:responsive-menu:end -->)#$1\n    <!-- WC360_POST_EXPORT:video-cover:start -->\n    <script src="custom/wc360-video-cover.js?v=1"></script>\n    <!-- WC360_POST_EXPORT:video-cover:end -->#s' "$INDEX_FILE"
